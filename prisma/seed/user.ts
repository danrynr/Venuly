...
async function userSeeder() {
  ...
  const firstNames = [
    "Budi", "Siti", "Agus", "Dewi", "Eko", "Ani", "Bambang", "Rini", "Dedi", "Sri",
    "Andi", "Maya", "Hendra", "Indah", "Rudi", "Lestari", "Anto", "Fitri", "Tono", "Sari",
    "Joko", "Kartini", "Mulyono", "Ratna", "Slamet", "Yanti", "Asep", "Lilis", "Dadang", "Eneng",
    "Fajar", "Gita", "Hafiz", "Ira", "Jajang", "Kiki", "Lutfi", "Mira", "Nana", "Oki",
    "Panji", "Qori", "Rian", "Siska", "Taufik", "Uli", "Vina", "Wawan", "Xena", "Yuda",
    "Zaki", "Amelia", "Bagir", "Citra", "Dian", "Euis", "Farhan", "Ghani", "Hesti", "Iwan"
  ];
  const lastNames = [
    "Saputra", "Wijaya", "Kurniawan", "Sari", "Setiawan", "Pratama", "Utami", "Hidayat", "Susanti", "Nugroho",
    "Wulandari", "Santoso", "Lestari", "Gunawan", "Rahayu", "Budiman", "Permata", "Suryanto", "Puspita", "Siregar",
    "Mulyadi", "Kusuma", "Hardianto", "Nasution", "Siahaan", "Ginting", "Pohan", "Sitorus", "Sinaga", "Pasaribu",
    "Lubis", "Harahap", "Ritonga", "Pane", "Batubara", "Tanjung", "Daulay", "Matondang", "Simanjuntak", "Sumbayak",
    "Saragih", "Damanik", "Purba", "Girsang", "Munthe", "Sipayung", "Haloho", "Sinurat", "Manurung", "Pardede",
    "Situmorang", "Silaen", "Nababan", "Hutagalung", "Hutapea", "Hutauruk", "Hutabarat", "Lumbantobing", "Aritonang", "Bawole"
  ];
  ...
  console.log("Seeded 60 users with varied referral logic, points, and coupons.");
}
